...
// ========================================================================
//	>> CItem_BoxmalorianRounds
// ========================================================================
class CItem_BoxmalorianRounds : public CItem
{
public:
	DECLARE_CLASS(CItem_BoxmalorianRounds, CItem);

	void Precache(void)
	{
		PrecacheModel("models/items/malorianammo.mdl");
	}
	void Spawn(void)
	{
		Precache();
		SetModel("models/items/malorianammo.mdl");
		BaseClass::Spawn();
	}

	bool MyTouch(CBasePlayer* pPlayer)
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_malorian, "malorian"))
		{
			if (g_pGameRules->ItemShouldRespawn(this) == GR_ITEM_RESPAWN_NO)
			{
				UTIL_Remove(this);
...
LINK_ENTITY_TO_CLASS(item_ammo_malorian, CItem_BoxmalorianRounds);


// ========================================================================
//	>> CItem_LargeBoxmalorianRounds
// ========================================================================
class CItem_LargeBoxmalorianRounds : public CItem
{
public:
	DECLARE_CLASS(CItem_LargeBoxmalorianRounds, CItem);

	void Precache(void)
	{
		PrecacheModel("models/items/malorianammobox.mdl");
	}
	void Spawn(void)
	{
		Precache();
		SetModel("models/items/malorianammobox.mdl");
		BaseClass::Spawn();
	}

	bool MyTouch(CBasePlayer* pPlayer)
	{
		if (ITEM_GiveAmmo(pPlayer, SIZE_AMMO_malorian_LARGE, "malorian"))
		{
			if (g_pGameRules->ItemShouldRespawn(this) == GR_ITEM_RESPAWN_NO)
			{
				UTIL_Remove(this);
...
LINK_ENTITY_TO_CLASS(item_ammo_malorian_large, CItem_LargeBoxmalorianRounds);
...
const char* CItem_AmmoCrate::m_lpzModelNames[NUM_AMMO_CRATE_TYPES] =
{
	...
	"models/items/ammocrate_smg1.mdl",		// malorian
