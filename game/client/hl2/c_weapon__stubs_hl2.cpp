...
STUB_WEAPON_CLASS( weapon_BTG, WeaponBTG, C_BaseHLCombatWeapon );
...
STUB_WEAPON_CLASS( weapon_supershotgun, WeaponSupershotgun, C_BaseHLCombatWeapon);
...
STUB_WEAPON_CLASS( weapon_malorian, Weaponmalorian, C_BaseHLCombatWeapon );
